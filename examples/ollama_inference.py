...
def main():
    if len(sys.argv) < 2:
        print("Usage: python ollama_inference.py <model_name_or_path> [tokenizer_id]")
        print("Example: python ollama_inference.py mistral-small:22b mistralai/Mistral-Small-Instruct-2409")
        return
